...
import PhoneAuthImage from "../../components/PhoneAuthImage";
  ...
  return (
    <View style={styles.container}>
      ...
      <BigButton
        ...
        title={"Sign In"}
        titleStyle={{ fontSize: 50 }} background={undefined} activeOpacity={undefined} containerStyle={undefined} buttonStyle={undefined}      />
    </View>
  );
};
